...
description: 'Generate a new API method for the Suite API which is part of the Subscription API project'
---
...
- The `Suite` API is part of the `Subscription` database, so you will need to create or update the `Suite` table in the `Subscription` database.
